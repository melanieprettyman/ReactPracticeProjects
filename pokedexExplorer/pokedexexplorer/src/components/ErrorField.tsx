/**
 * `ErrorField` is a component that displays an error message in a styled card format.
 * It is used to inform users when no search results are found or when an expected data fetch fails in PokemonItem.
 */
